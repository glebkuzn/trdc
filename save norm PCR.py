...
FAM_ratio = FAM_data_cell
# print FAM_ratio
FAM_ini=FAM_data_cell[:,5:6].repeat(sh,axis=1)
FAM_fin=FAM_data_cell[:,sh-2:sh-1].repeat(sh,axis=1)
FAM_2i_ini=FAM_data_cell[:,5:6].repeat(sh,axis=1)
FAM_2i_fin=FAM_data_cell[:,sh-2:sh-1].repeat(sh,axis=1)
# print FAM_2i_fin
...
CY5_ini=CY5_data_cell[:,5:6].repeat(sh,axis=1)
CY5_fin=CY5_data_cell[:,sh-2:sh-1].repeat(sh,axis=1)
CY5_2i_ini=CY5_data_cell[:,5:6].repeat(sh,axis=1)
CY5_2i_fin=CY5_data_cell[:,sh-2:sh-1].repeat(sh,axis=1)
# print CY5_2i_fin
